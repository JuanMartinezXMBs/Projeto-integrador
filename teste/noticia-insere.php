...
if(isset($_POST['inserir'])){
	...
	/* Obtrendo o id do usuario que está logada na sessão, e que está cadastrando uma noticia */
...
<div class="row">
	<article class="col-12 bg-white rounded shadow my-1 py-4">
		...
		<!-- O atributo enctype com o valor, permite ao formulario receber arquivos -->
